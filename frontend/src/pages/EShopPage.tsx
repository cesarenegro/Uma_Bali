              ...
              <div className="flex flex-col flex-1">
                <div className="flex flex-col gap-1 mb-1">
                  ...
                  <span className="font-medium text-espresso text-xs">
                    {product.price ? format(product.price) : <span className="text-brand text-[9px] uppercase tracking-wider">{t('shop.price_on_request', 'Price on Request')}</span>}
                  </span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="p-8 flex flex-col">
                  ...
                  <div className="text-lg font-medium text-espresso mb-4">
                    {selectedProduct.price ? format(selectedProduct.price) : <span className="text-brand text-sm uppercase tracking-wider">{t('shop.price_on_request', 'Price on Request')}</span>}
                  </div>
